package usc.votingsystem.repository;

import usc.votingsystem.VotingsystemApp;
import usc.votingsystem.config.Constants;
import usc.votingsystem.config.audit.AuditEventConverter;
import usc.votingsystem.domain.PersistentAuditEvent;
...
import static usc.votingsystem.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
